...
@export_range(0, 5000, 50) var move_speed = 2000
@export_group("Visual")
@export var icon: Texture2D
@export_enum("UL", "UR", "DL", "DR") var orientation = 0
@export var animation_played: String = "idle"
@export var animation_resource: PackedScene #holds a scene with AnimationPlayer
@export var sprite_offset: Vector2
@export var sprite_offsets: Dictionary = {}
@export_group("Skills")
